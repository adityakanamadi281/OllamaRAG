...
# Load Data
# --------------------------------------------------
file_path = r"C:\Users\adity\OllamaRAG\data\swiggy_full_text.txt"
with open(file_path, "r", encoding="utf-8") as f:
    df = f.read()
#df=pd.read_json(r"C:\Users\adity\OllamaRAG\data\swiggy_instamart.json")
...
documents = [
    Document(
        page_content=df,
        metadata={"source": "swiggy_full_text.txt"}
    )
]
# documents = []
...
#     Order DateTime: {row['OrderDateTime']}
#     Delivery time: {row['Delivery time']}
#     Product Category: {row['Product Category']}
#     Order value: {row['Order value']}
#     Customer Feedback: {row['Customer Feedback']}
#     Service Rating: {row['Service Rating']}
#     Delivery Delay: {row['Delivery Delay']}
#     Refund Requested: {row['Refund Requested']}
#     """
#     documents.append(
#         Document(page_content=content, metadata={"row_id": idx})
#     )
